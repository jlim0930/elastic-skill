...
5. **Documentation & API Lookup**: Always use https://www.elastic.co/docs for general information lookup and use https://www.elastic.co/docs/api/doc/elasticsearch/ to craft and verify API calls.
